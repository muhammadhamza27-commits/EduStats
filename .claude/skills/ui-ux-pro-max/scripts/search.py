...
Stacks: react, nextjs, vue, svelte, astro, swiftui, react-native, flutter, nuxtjs, nuxt-ui,
        html-tailwind, shadcn, jetpack-compose, threejs
...
if __name__ == "__main__":
    ...
    # Persistence
    parser.add_argument("--persist", action="store_true", help="Save design system to MASTER.md")
    ...
    if args.design_system:
        ...
        if args.persist:
            ...
            print("")
            print(f"📖 Usage: When building a page, check")
            print(f"   design-system/{project_slug}/pages/[page].md first.")
